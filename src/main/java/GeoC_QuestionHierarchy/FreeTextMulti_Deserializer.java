...
public class FreeTextMulti_Deserializer implements JsonDeserializer<FreeTextMulti>{

	public FreeTextMulti deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context) throws JsonParseException {
		...
		FreeTextMulti freetextmulti = new FreeTextMulti(quesID, quesLabel, subcomponent);
		
		return freetextmulti;
	}
